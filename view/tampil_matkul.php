    ...
    <div>
      ...
      <ul
        ...
        <li  class="mt-2"><a href="../login/logout.php" class="p-3 hover:p-4 hover:text:xl  ease-in duration-300"><i class="ri-logout-box-line"></i>Logout</a></li>
                        ...
                        <a class="btn btn-sm rounded" href="../print/cetakdata_mk.php">Cetak Data</a>
                        <a class="btn btn-sm rounded bg-green-400 text-white hover:bg-green-700 " href="../form/tambah_matkul.php">Tambah Matakuliah</a>    
            </div>
        ...
        <h1 class="font-bold text-2xl text-sky-600 drop-shadow-md">Matakuliah</h1>
            <div class="pt-5 pb-5 flex items-center justify-center w-full overflow-x-auto">
                ...
                <table class=" border-white pb-auto w-full table table-zebra">
                    ...
                    <tr class="pointer hover:bg-gray-200">
                        ...
                        <td><a class="bg-red-500 text-gray-200 hover:bg-red-700 btn " href="../proses/crud_matkul.php?id=<?php echo $row['id_mk'];?>&aksi_mk=hapus"><i class="ri-delete-bin-7-line"></i></a></td>
                    </tr>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /> 
                ...
                <!-- start main content  -->
                    <div class=" leading-7 text-left text-sm " id="submenu1">
                        ...
                        <a href="tampil_matkul.php"><h1 class="cursor-pointer p-1 hover:bg-gray-700 rounded-md mt-1 text-gray-200 pl-5  bg-slate-600">•  Matkul</h1></a>
